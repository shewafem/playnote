	...
	return (
		<Container className="flex items-center justify-center mt-10">
			...
			>
				...
				<p className="mb-4 text-center text-md sm:text-xl text-muted-foreground leading-relaxed sm:max-w-[65ch] max-w-[50ch]">
					Улучшайте свое мастерство на гитаре с интерактивными инструментами: онлайн-база аккордов, фретборд и практика
					любимых песен в реальном времени для игроков любого уровня!
				</p>
